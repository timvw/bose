...
## [0.2.11](https://github.com/timvw/bose/compare/v0.2.10...v0.2.11) - 2026-09-15

### Other

- *(deps)* update rust crate clap to v4.6.7 ([#73](https://github.com/timvw/bose/pull/73))
- *(deps)* update rust crate clap to v4.6.5 ([#72](https://github.com/timvw/bose/pull/72))
